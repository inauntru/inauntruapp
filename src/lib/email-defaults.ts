...
${body}
    ...
    <p style="color:#b0b8c1;font-size:12px;text-align:center;margin:0;">© 2026 INAUNTRU · România &nbsp;·&nbsp; <a href="#" style="color:#b0b8c1;">Dezabonare</a></p>
  </div>
</body>
</html>`;
...
export const EMAIL_DEFAULTS: Record<string, EmailDefault> = {
  verify_email: {
    ...
    <p style="color:#4a5568;font-size:16px;line-height:1.75;">Ești aproape! Confirmă-ți adresa de email pentru a accesa spațiul tău de liniște de pe INAUNTRU.</p>
  ...
  change_email: {
    ...
    <p style="color:#4a5568;font-size:16px;line-height:1.75;">Dragă <strong>{{prenume}}</strong>,</p>
    <p style="color:#4a5568;font-size:16px;line-height:1.75;">Ai solicitat schimbarea adresei de email a contului tău INAUNTRU la <strong>{{email}}</strong>. Apasă butonul de mai jos pentru a confirma.</p>
    <div style="text-align:center;margin:32px 0;">
  ...
  invite_user: {
    ...
    body: SHELL(`    <h1 style="font-family:Georgia,serif;color:#1a3a0a;font-size:22px;margin:0 0 16px;">Invitație echipă INAUNTRU</h1>
    <p style="color:#4a5568;font-size:16px;line-height:1.75;">Bună,</p>
    <p style="color:#4a5568;font-size:16px;line-height:1.75;">Ai fost invitat să te alături echipei INAUNTRU cu rolul de <strong>{{rol}}</strong>. Apasă butonul de mai jos pentru a accepta invitația și a-ți seta parola.</p>
    <div style="text-align:center;margin:32px 0;">
  ...
  welcome: {
    ...
    <p style="color:#4a5568;font-size:16px;line-height:1.8;">Ai făcut primul pas spre echilibrul interior. Spațiul tău INAUNTRU este pregătit — cu practici ghidate, check-in-uri zilnice și sesiuni LIVE cu facilitatorii noștri.</p>
  ...
  getting_started: {
    ...
    <p style="color:#4a5568;font-size:16px;line-height:1.75;">Ieri ai făcut primul pas. Azi îți arătăm cum să transformi INAUNTRU în rutina ta de echilibru.</p>
  ...
  sub_activated: {
    ...
    <div style="background:#f0f7ee;border-radius:12px;padding:20px 24px;margin:20px 0;">
      ...
      <ul style="color:#4a5568;font-size:14px;line-height:2;margin:0;padding-left:20px;">
        <li>Toate practicile din biblioteca INAUNTRU</li>
  ...
  trial_ending: {
    ...
    <p style="color:#4a5568;font-size:16px;line-height:1.75;">Dragă <strong>{{prenume}}</strong>,</p>
    <p style="color:#4a5568;font-size:16px;line-height:1.75;">Perioada ta de probă gratuită se termină pe <strong>{{data_expirare}}</strong>. Dacă vrei să continui accesul la practicile și sesiunile INAUNTRU, alege un plan care ți se potrivește.</p>
    <div style="text-align:center;margin:28px 0;">
