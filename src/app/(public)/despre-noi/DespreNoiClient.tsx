        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <AnimateIn from="bottom">
              ...
              <p className="font-body text-body-lg text-secondary-text leading-relaxed">{t("body", "WithIn s-a născut din convingerea că fiecare persoană din România merită acces la practici de reglare somatică de calitate — disponibile oricând, oriunde.")}</p>
            </AnimateIn>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <AnimateIn from="right">
              ...
              <h2 className="font-heading text-h2 text-deep-green mb-4">{t("founder_title", "De ce am creat WithIn")}</h2>
              <div className="space-y-4 text-secondary-text font-body text-body-md leading-relaxed">
                ...
                <p>{t("founder_body3", "WithIn este răspunsul nostru: o platformă care aduce știința somatică în viața cotidiană a românilor, cu practici accesibile, facilitatori locali certificați și un sistem inteligent de personalizare.")}</p>
              </div>
            </AnimateIn>
          </div>
        </div>
