      ...
      <div className="card p-8 md:p-10">
        {done ? (
          <div className="text-center py-4">
            ...
            <h2 className="font-heading text-h2 text-deep-green mb-3">{tr("Parolă actualizată!")}</h2>
            <p className="font-body text-body-md text-secondary-text">
              {tr("Ești redirecționat(ă) la autentificare...")}
            </p>
          </div>
        ) : (
          <>
            <div className="text-center mb-8">
              ...
              <h1 className="font-heading text-h2 text-deep-green mb-2">{tr("Setează parola nouă")}</h1>
              <p className="font-body text-body-sm text-secondary-text">
                {tr("Alege o parolă nouă pentru contul tău.")}
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder={tr("Minim 6 caractere")}
                    required
              ...
              <button type="submit" disabled={loading || !password || !confirm} className="btn btn-primary w-full disabled:opacity-50">
                {loading ? (
                  ...
                  <>{tr("Salvează parola nouă")} <ArrowRight size={16} weight="bold" /></>
                )}
              </button>
            </form>
          </>
