...
export default function AuthLayout({ children }: { children: ReactNode }) {
  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: "#EAF5EE" }}>
      {/* Logo centrat */}
      <header className="pt-10 pb-2 flex flex-col items-center">
        <Link href="/" className="flex flex-col items-center gap-1">
          ...
          <span className="font-ui text-label-xs text-secondary-text uppercase tracking-widest">Terapie Somatică Digitală</span>
        </Link>
      </header>
