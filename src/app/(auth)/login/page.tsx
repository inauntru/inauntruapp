...
export default function LoginPage() {
  ...
  return (
    <div className="w-full max-w-4xl">
      {/* Mobile tabs */}
      <div className="flex md:hidden mb-6 bg-white rounded-full p-1 shadow-sm border border-sage-border">
        <button
          onClick={() => setActiveTab("login")}
          className={`flex-1 py-2 rounded-full font-ui text-body-sm font-medium transition-all ${activeTab === "login" ? "bg-deep-green text-white" : "text-secondary-text"}`}
        >
          Conectare
        </button>
        <button
          onClick={() => setActiveTab("register")}
          className={`flex-1 py-2 rounded-full font-ui text-body-sm font-medium transition-all ${activeTab === "register" ? "bg-deep-green text-white" : "text-secondary-text"}`}
        >
          Înregistrare
        </button>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        {/* ── LOGIN ── */}
        <div className={`bg-white rounded-2xl p-8 shadow-card border border-sage-border/60 ${activeTab === "register" ? "hidden md:block" : ""}`}>
        ...
        {/* ── REGISTER ── */}
        <div className={`bg-white rounded-2xl p-8 shadow-card border border-sage-border/60 ${activeTab === "login" ? "hidden md:block" : ""}`}>
          ...
          <p className="text-center font-body text-body-sm text-secondary-text/70 mt-6 italic">
